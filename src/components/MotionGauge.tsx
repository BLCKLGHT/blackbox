export function MotionGauge({ magnitude }: { magnitude: number }) {
    ...
    <section className="rounded-lg border border-cockpit-line bg-cockpit-900 p-4">
      <div className="flex items-end justify-between gap-3">
        <div>
          ...
          <div className="mt-1 text-3xl font-black tabular-nums">{magnitude.toFixed(1)}</div>
        </div>
        <div className="text-sm text-slate-400">m/s²</div>
      </div>
      <div className="mt-3 h-2 rounded-full bg-cockpit-800">
