...
export function getVideoConstraints(quality: VideoQuality): MediaTrackConstraints {
  ...
  if (quality === "high") return { ...base, width: { ideal: 1920 }, height: { ideal: 1080 }, frameRate: { ideal: 30, max: 60 } };
  return { ...base, width: { ideal: 1280 }, height: { ideal: 720 }, frameRate: { ideal: 30, max: 60 } };
}
